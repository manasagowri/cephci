...
#     configure_listeners(nvme_service.gateways, nvme_service.config, listeners=listeners)
...
#             "lb_groups": lb_groups
#         }
#         configure_namespaces(nvme_service.gateways, nvme_service.config, opt_args)
